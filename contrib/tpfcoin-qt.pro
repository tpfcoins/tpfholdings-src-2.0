...
RESOURCES += src/qt/tpfcoin.qrc src/qt/tpfcoin_locale.qrc

TRANSLATIONS += src/qt/locale/tpfcoin_bg.ts \
                src/qt/locale/tpfcoin_de.ts \
                src/qt/locale/tpfcoin_en.ts \
                src/qt/locale/tpfcoin_es.ts \
                src/qt/locale/tpfcoin_fi.ts \
                src/qt/locale/tpfcoin_fr.ts \
                src/qt/locale/tpfcoin_it.ts \
                src/qt/locale/tpfcoin_ja.ts \
                src/qt/locale/tpfcoin_pl.ts \
                src/qt/locale/tpfcoin_pt.ts \
                src/qt/locale/tpfcoin_ru.ts \
                src/qt/locale/tpfcoin_sk.ts \
                src/qt/locale/tpfcoin_sv.ts \
                src/qt/locale/tpfcoin_vi.ts \
                src/qt/locale/tpfcoin_zh_CN.ts \
                src/qt/locale/tpfcoin_zh_TW.ts
