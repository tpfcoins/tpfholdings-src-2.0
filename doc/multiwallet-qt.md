...
In order to support loading of multiple wallets in tpfcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tpfcoin.cpp.
...
Changes to tpfcoin.cpp
----------------------
tpfcoin.cpp is the entry point into tpfcoin-qt, and as such, will require some minor modifications to provide hooks for
