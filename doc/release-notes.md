TPFCoin Core version 2.2.1 is now available from:

  <https://github.com/tpfcoin-project/tpfcoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/tpfcoin-project/tpfcoin/issues>

Compatibility
==============

TPFCoin Core is extensively tested on multiple operating systems using
...
TPFCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that TPFCoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/tpfcoin-project-translations/).
