Contributing to TPFCoin Core
============================

The TPFCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TPFCoin Core project, and is not to be
confused with overall TPFCoin Network Protocol consensus changes.

Whether a pull request is merged into TPFCoin Core rests with the project merge
...
Patches that change TPFCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TPFCoin consensus, it must have been
...
The project leader is the release manager for each TPFCoin Core release.
