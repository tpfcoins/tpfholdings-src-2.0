...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TPFCoin Core tpfcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tpfcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tpfcoin transaction") + "\n" +
                               "  tpfcoin-tx [options] -create [commands]   " + _("Create hex-encoded tpfcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tpfcoin transaction
