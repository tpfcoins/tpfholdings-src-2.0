                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TPFCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TPFCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tpfcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TPFCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TPFCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TPFCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TPFCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TPFCoin addresses"));
    ...
    openInfoAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Information"), this);
    ...
    openAction->setStatusTip(tr("Open a TPFCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/browse"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TPFCoin Core help message to get a list with possible TPFCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TPFCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TPFCoin network", "", count));
}
...
{
    QString strTitle = tr("TPFCoin Core"); // default title
