...
/** Utility functions used by the TPFCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TPFCoin addresses in monospace font
...
// Parse "tpfcoin:" URI into recipient object, return true on successful parsing
