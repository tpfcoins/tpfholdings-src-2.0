...
#define SPORK_2_SWIFTTX_DEFAULT 978307200                        //2001-1-1 978307200 
#define SPORK_3_SWIFTTX_BLOCK_FILTERING_DEFAULT 1424217600       //2015-2-18 1424217600 
#define SPORK_5_MAX_VALUE_DEFAULT 1000                           //1000 TPF
#define SPORK_7_MASTERNODE_SCANNING_DEFAULT 978307200            //2001-1-1 978307200 
...
public:
    ...
    uint256 GetHash()
    {
        uint256 n = HashTribus(BEGIN(nSporkID), END(nTimeSigned));
        return n;
    }
