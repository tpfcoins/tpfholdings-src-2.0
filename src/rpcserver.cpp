...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "TPFCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TPFCoin features */
        {"tpfcoin", "masternode", &masternode, true, true, false},
        {"tpfcoin", "masternodelist", &masternodelist, true, true, false},
        {"tpfcoin", "mnbudget", &mnbudget, true, true, false},
        {"tpfcoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"tpfcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tpfcoin", "mnsync", &mnsync, true, true, false},
        {"tpfcoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"tpfcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tpfcoind, or the -server option to tpfcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tpfcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37738/\n";
}
